    ...
    $.ajax({
        ...
        function renderButtons() {
            for (let i = 0; i < weather.length; i++) {
                ...
                btn.addClass("weather-btn btn btn-default");
        ...
        $("#add-weather").on("click", function (event) {
            ...
            // add movie ftom the textbox to our array
        ...
        // add a click event listener to all elements with a class of weather-buttom
