...
let cities = ["New York City", "Boston", "Washington DC", "Philadelphia", "Detroit", "San Francisco"];


function displayWeatherInfo() {

    var city = $(this).attr("data-name");
    var queryURL = `https://api.openweathermap.org/data/2.5/weather?q=boston&units=imperial&APPID=c94ac49bcd423ef700d020797840e0c4`;
    ...
    $.ajax({
        ...
        $("#searchBtn").on("click", function (event) {
            ...
            let weather = $("#city-input").val().trim();
            // display the city info in the 'city-info' div
            let 
